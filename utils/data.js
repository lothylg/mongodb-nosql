...
const usernames = [
  ...
  const emails = [
    ...
    "daniel.rodriguez333@example.info",
    "olivia.garcia444@example.name",
    "noah.harris555@example.cc",
    "ava.lee666@example.pro",
    "liam.martin777@example.aero",
    "isabella.clark888@example.asia",
    "jacob.walker999@example.tel",
    "mia.hernandez000@example.coop",
    "benjamin.wright111@example.museum",
    "amelia.king222@example.jobs",
    "elijah.adams333@example.name",
    "chloe.thomas444@example.mobi",
    "aiden.carter555@example.int",
    "madison.perez666@example.coop",
    "lucas.white777@example.us",
    "harper.lee888@example.asia",
